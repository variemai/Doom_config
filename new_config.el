...
(setq mu4e-get-mail-command "mbsync -V -a > /home/vardas/mbsync.log")
...
(setq mu4e-contexts
      ...
      (make-mu4e-context
		 ...
		 (when msg
          ...
          :vars '( ( user-mail-address . "vardas@ics.forth.gr")
                   ...
                   ( smtpmail-smtp-user . "vardas")
                   (smtpmail-starttls-credentials . (("enigma.ics.forth.gr" 465 nil nil)))
                   (smtpmail-auth-credentials . (expand-file-name "/home/vardas/authinfo.gpg"))
      ...
      (make-mu4e-context
       ...
       :vars '( ( user-mail-address . "johnvardas@hotmail.com")
                ( user-full-name . "Ioannis Vardas")
                ( message-send-mail-function . smtpmail-send-it )
                ( smtpmail-smtp-user . "johnvardas")
                (smtpmail-starttls-credentials . (("enigma.ics.forth.gr" 587 nil nil)))
                (smtpmail-auth-credentials . (expand-file-name "/home/vardas/authinfo.gpg"))
