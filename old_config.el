...
(setq mu4e-reply-to-address "johnvardas@hotmail.com"
      user-mail-address "johnvardas@hotmail.com"
      user-full-name "Ioannis Vardas")
(setq mail-user-agent 'mu4e-user-agent)
(setq mu4e-maildir (expand-file-name "~/Maildir"))
(setq mu4e-compose-in-new-frame t)
;; (require 'pinentry)
;; (setq mu4e-get-mail-command (format "INSIDE_EMACS=%s mbsync -D hotmail > /home/vardas/mbsync.log" emacs-version)
;;       epa-pinentry-mode 'ask)
;; (pinentry-start)
(setq mu4e-get-mail-command "mbsync -V hotmail > /home/vardas/mbsync.log")
...
(setq mu4e-sent-folder  "/hotmail/Sent")
(setq mu4e-drafts-folder  "/hotmail/Drafts")
(setq mu4e-trash-folder  "/hotmail/Deleted")
(setq mu4e-refile-folder  "/hotmail/Archive")
...
;; 	    (smtpmail-queue-dir . "~/Maildir/hotmail/queue/cur")
